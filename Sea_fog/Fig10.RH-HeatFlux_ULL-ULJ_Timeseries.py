...
idr_w = f"./"
ifn_w = idr_w+f"sstx-wrfout_Fog_{domain}_2020-08-17_18:00:00.nc"  #sst_fix
ifn_w2= idr_w+f"skin-wrfout_Fog_{domain}_2020-08-17_18:00:00.nc"  # sst_skin

idr_c = f"./"
ifn_c = idr_c+f"cpld_wrfout_{domain}_2020-08-17_18:00:00.nc"  # solar_source
...
fig, axes = plt.subplots(2, 3, figsize=(12, 6),gridspec_kw={'hspace': 0.22, 'wspace': 0.3}) 
...
for idx, position in enumerate(region_points):
    ...
    landmask1 = ds_ct.variables['LANDMASK'][0, lat_range, lon_range]  
    landmask2 = ds_cp.variables['LANDMASK'][0, lat_range, lon_range]  
