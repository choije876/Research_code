...
if domain == "01":
   ...
   lat_max =45.0 ; elat = 42 
   lat_min =33.0 ; slat = 34 
...
# =========================================================
idr_w = "./"
ifn_w =idr_w+f"sstx-_wrfout_Fog_{domain}_2020-08-17_18:00:00.nc"
idr_c =f"./"
ifn_c = idr_c+f"hycom_GLBy0.08_expt_93.0_2020-08-17T18Z_subset.nc" 
...
cbar_ax1 = fig.add_axes([0.15, 0.18, 0.7, 0.015]) 
